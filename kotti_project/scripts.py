...
def _translate(new_package_name, original_package_name='kotti_project'):
    """ Translate package """

    def package_split(package_name, separator='.'):
        """ With 'pippo.pluto.paperino' you'll get:
            ['pippo.pluto.paperino','pippo.pluto', 'pippo', 'pluto',
             'paperino']
        """
